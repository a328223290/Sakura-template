...
(function ($) {
	...
	class Silence {
			...
			this.defaluts = {
				...
				topImg: {
					homeTopImg: [
                        ...
                        "https://pic.imgdb.cn/item/65b88563871b83018ae2283a.jpg"
					],
					notHomeTopImg: [
				...
				topInfo: {
					title: 'アホのブログ',
					text: 'どうぞごゆっくり。',
					github: "https://github.com/a328223290",
					weibo: "",
					telegram: "",
					music: "",
					twitter: "",
		...
		buildCustomElements() {
			...
			$title.html($title.html().replace(`残星落影 | ${autherName}`, `${blogTitle}`));
			...
			// $("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/lht1132950411/articles/11177049.html">友链</a><i></i></li><li><a id="blog_nav_myzanshang" class="menu" href="https://www.cnblogs.com/lht1132950411/articles/11340077.html">赞赏</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
			...
			// 		'<li><a href="https://www.cnblogs.com/lht1132950411/articles/11157339.html "><i class="fa fa-meetup" aria-hidden="true"></i> 我？</a></li>' +
			// 		'<li><a href="https://www.cnblogs.com/lht1132950411/articles/11346906.html "><i class="fa fa-area-chart" aria-hidden="true"></i> 统计</a></li>' +
			// 		'<li><a href="https://www.cnblogs.com/lht1132950411/articles/11350777.html "><i class="fa fa-heartbeat" aria-hidden="true"></i> 监控</a></li>' +
			// 		'<li><a href="https://www.cnblogs.com/lht1132950411/p/11541835.html "><i class="iconfont icon-taohua" aria-hidden="true"></i> 主题</a></li>' +
			// 		'</ul>';
		...
		buildPostSponsor() {
            ...
            <div class="esa-sponsor">
                <a class="github" href="${github.enable ? github.link : 'https://gitee.com/lhtqq1132950411'}" target="_blank" class="posa tr3" title="Github"></a>
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a alt="懶人博客">' +
					'<ruby><span class="sakuraso">仕事中</span><span class="no">の</span><span class="shironeko">社畜だ！</span>' +
					'<rt class="chinese-font">好想下班</rt></ruby></a></span>'+
					'</div>'
			$('body').prepend(title);
		...
		mainHeader() {
			...
			var header =
					...
					`       <h1 class="center-text glitch is-glitching Ubuntu-font" data-text="アホのブログ">${config.title}</h1>` +
		...
		setHomeSuiBiList() {
			...
			for (let i = article_list.length - 1; i >= 0; i--) {
				...
				let postTitle = $('.day').find('div.postTitle')[i].innerHTML;//<a class="postTitle2" href="https://www.cnblogs.com/lht1132950411/p/11194299.html">[置顶] 博客园美化</a>
				let readMore = $('.day').find('a.c_b_p_desc_readmore')[i].href;//https://www.cnblogs.com/lht1132950411/p/11194299.html
				...
				let html = `<div class="post post-list-thumb post-list-show">` +
						...
						`     <div class="post-meta"> <span><i class="iconfont icon-attention"></i>${readNum} 热度</span> <span class="comments-number"><i class="iconfont icon-mark"></i>${comNum} 条评论</span> <span><i class="iconfont icon-cc-user"></i><a href="https://www.cnblogs.com/xkge"></a>${author}</span></div>` +
		...
		postHeader() {
			...
			if (window.location.href.indexOf('articles') === -1) {
				var header =
						`<p class="entry-census"><span><a href="https://github.com/a328223290"><img src="${config.avatar}"></a></span><span><a href="https://github.com/a328223290">${config.authorName}</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`;$('.pattern-header').append(header)
